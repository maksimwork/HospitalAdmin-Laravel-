            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Manage Exercise Sub Types</h4> 
                    </div>
                    <!-- <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        
                        <ol class="breadcrumb">
                            <li><a href="javascript:void(0);">Library</a></li>
                            <li class="active">Sub Type Title</li>
                        </ol>
                    </div> -->
                </div>   
                            ...
                            <div class="table-responsive m-t-40">
                                <table class="table borderlesstable" id="myTable">
                                    <thead>
                                                ...
                                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="form-material form-horizontal" action="/subtypeaddaction" accept-charset="UTF-8">
                                        ...
                                        <tbody>
                                        @foreach ($subtype->reverse() as $subtypeitem)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$subtypeitem->subtypetitle}}</td>
                                                
                                                <td>                                           
                                                </td>
                                                <td class="text-center">
                                                    <a href = "/subtypeedit/{{$subtypeitem->id}}" class="btn btn-block btn-info" style = "width:100px; float:right; background-color:#0095D4; border-raidus:2px;color:#FFF;"    >Edit</a>
                                                </td>
                                                <td class="text-center">
                                                    <a href = "/subtypedelete/{{$subtypeitem->id}}" class="btn btn-block"   style = "width:100px;background-color:#C4161C; color:#fff;border-radius:2px;">Delete</a>
                                                </td>
