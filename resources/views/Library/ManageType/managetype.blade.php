            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Manage Exercise Type</h4> 
                    </div>
                            ...
                            <div class="table-responsive m-t-40">
                                <table class="table borderlesstable" id="myTable">
                                    <thead>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <!-- <form class="form-material form-horizontal" action="/categoryaddaction" accept-charset="UTF-8">
                                                                <div class="form-group">
                                                                    <label class="col-md-12" for="example-text">Category Title</span></label>
                                                                    <div class="col-md-12">
                                        ...
                                        <tbody>
                                        @foreach ($type->reverse() as $typeitem)
                                            <tr>
                                                ...
                                                <td>{{$typeitem->typetitle}}</td>
                                                <td></td>
                                                <td class="text-center">
                                                    <a href = "/typeedit/{{$typeitem->id}}" class="btn btn-block btn-info" style = "width:100px; float:right; background-color:#0095D4; border-raidus:2px;color:#FFF;" >Edit</a>
                                                </td>
                                                <td class="text-center">
                                                    <a href = "/typedelete/{{$typeitem->id}}" class="btn btn-block " style = "width:100px;background-color:#C4161C;border-radius:2px; color:#fff;">Delete</a>
                                                </td>
