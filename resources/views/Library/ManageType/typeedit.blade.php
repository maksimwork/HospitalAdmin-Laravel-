        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <form class="form-material form-horizontal" action="/typeeditaction" accept-charset="UTF-8">
                                <div class="form-group">
                                    <label class="col-md-12" for="example-text">Type Title</span></label>
                                    <div class="col-md-12">
                                        <input type="text" id="example-text" name="typetitle" class="form-control" value={{$type->typetitle}}>
                                        <input type="hidden" id="example-text" name="previous" class="form-control" value={{$type->typetitle}}>
                                    </div>
                                </div>
