...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="main">
        ...
        <h1 style="font-style: italic;">A user account has been created for you</h1>

        <div style = "margin-top:30px">
            <p>Please click the following link to activate your account which you can use to access your therapy exercises.</p>
        </div>
