            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Physio</h4> 
                    </div>
                    <!-- <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        
                        <ol class="breadcrumb">
                            <li><a href="javascript:void(0);">Therapist</a></li>
                            <li class="active">Add Physio</li>
                        </ol>
                    </div> -->
                </div>   
                        ...
                        <div class="white-box">
                            <form class="form-material form-horizontal" action="/physioaddaction" accept-charset="UTF-8">
                                <div class="form-group">
                                    <label class="col-md-12" for="example-text">Physio Name</span></label>
                                    <div class="col-md-12">
                                        <input type="text" id="example-text" name="namefield" class="form-control" placeholder="enter physio name">
                                    </div>
                                </div>
