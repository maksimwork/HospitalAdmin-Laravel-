                                ...
                                <table class="table borderlesstable" id="myTable">
                                    <thead>
                                        ...
                                        <tr class = "head" style = "background-color:rgb(245, 245, 245);">
                                            ...
                                            <th class="text-center">
                                                    <button type="button" class="btn btn-block btn-success"  data-toggle="modal" data-target="#exampleModal" style = "width:100px; float:right;background-color:#08d206;color:#FFF;">
                                                Add New
                                                </button>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-material form-horizontal" action="/departmentaddaction" accept-charset="UTF-8">
                                                                    <div class="form-group">
                                                                        <label class="col-md-12" for="example-text" style="text-align:left;">Department Name</span></label>
                                                                        <div class="col-md-12">
                                                                            <input type="text" id="example-text" name="titlefield" class="form-control" placeholder="enter department name">
                                                                        </div>
                                                                    </div>
                                        ...
                                        @foreach ($department as $departmentitem)
                                            ...
                                            <tr class = "head">
                                                ...
                                                <td>{{$departmentitem->departmenttitle}}</td>
                                                
                                                <td>                                           
                                                </td>
                                                <td class="text-center">
                                                    <a href = "/departmentedit/{{$departmentitem->id}}"  class="btn btn-block btn-info" style = "width:100px; float:right; background-color:#0095D4; border-raidus:2px;color:#FFF;"    >Edit</a>
                                                </td>
                                                <td class="text-center">
                                                    <a href = "/departmentdelete/{{$departmentitem->id}}" class="btn btn-block" style = "width:100px;background-color:#C4161C; color:#fff;border-radius:2px;">Delete</a>
                                                </td>
